...
def main():
    ...
    parser = argparse.ArgumentParser(description="Clean and process a driving simulation CSV file.")
    parser.add_argument("csv_file", help="Path to the CSV file to be cleaned")
